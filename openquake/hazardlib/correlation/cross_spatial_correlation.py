...
class DuNing2021CorrelationModel(BaseSpatialCrossCorrelationModel):
    ...
    PCA_COEFFS = CoeffsTable(
        ...
        table="""\
        imt         1       2       3       4       5       6       7
        SA(0.01)    0.2800  -0.150  0.0700  0.0400  -0.050	-0.100  -0.080
        SA(0.05)    0.2400 	-0.190	0.2300	0.0400	-0.180	-0.100	0.0600
        SA(0.075)   0.2100	-0.210	0.2900	0.0800	-0.170	0.0600	0.3400
        SA(0.1)     0.2000	-0.220	0.2700	0.0800	-0.090	0.1500	0.4500
        SA(0.2)     0.2200	-0.200	0.0900	0.0400	0.2300	0.3000	0.1100
        SA(0.3)     0.2400	-0.140	-0.110	0.0200	0.3900	0.2800	-0.110
        SA(0.4)     0.2400	-0.090	-0.190	-0.050	0.3700	0.2000	-0.130
        SA(0.5)     0.2400	-0.040	-0.250	-0.110	0.3100	0.0200	-0.010
        SA(0.75)    0.2300	0.0500	-0.300	-0.200	0.0800	-0.190	0.2200
        SA(1.0)     0.2200	0.1300	-0.270	-0.270	-0.100	-0.170	0.3200
        SA(1.5)     0.1900	0.2200	-0.200	-0.260	-0.230	0.0200	0.1900
        SA(2.0)     0.1900	0.2700	-0.100	-0.170	-0.270	0.2000	0.0600
        SA(3.0)     0.1700	0.3000	0.0600	0.0000  -0.250	0.3800	-0.200
        SA(4.0)     0.1600	0.3200	0.1200	0.1100	-0.110	0.3200	-0.140
        SA(5.0)     0.1500	0.3200	0.1500	0.2400	0.0600	0.1700	-0.080
        SA(7.5)     0.1200	0.3100	0.0800	0.3700	0.2300	-0.250	0.1600
        SA(10)      0.1200	0.3000	0.0100	0.4100	0.2000	-0.300	0.1800
        PGA         0.2800	-0.150	0.0700	0.0400	-0.050	-0.100	-0.080
        PGV         0.2600	0.1300	-0.080	0.0900	-0.100	-0.290	-0.230
        Ia          0.2300	-0.120	0.1900	-0.190	-0.100	-0.300	-0.430
        CAV         0.2600	0.0100	0.2500	-0.170	0.0200	-0.190	-0.230
        RSD575	    -0.090	0.2100	0.4100	-0.400	0.2900	-0.090	0.1000
        RSD595	    -0.070	0.2700	0.3600	-0.380	0.2700	0.0200	0.0900
    """,
    )  # noqa: E501

    MODEL_VARIO = {
        1: {"Cn": 1.03, "C1": 0.88, "A1": 15.0, "C2": 10.11, "A2": 200.00, "type": "iso nest"},
        2: {"Cn": 0.36, "C1": 1.76, "A1": 25.0, "C2": 2.61, "A2": 150.00, "type": "iso nest"},
        3: {"Cn": 0.13, "C1": 0.37, "A1": 25.0, "C2": 1.75, "A2": 200.00, "type": "iso nest"},
        4: {"Cn": 0.09, "C1": 0.26, "A1": 20.0, "C2": 1.11, "A2": 150.00, "type": "iso nest"},
        5: {"Cn": 0.10, "C1": 0.32, "A1": 15.0, "C2": 0.45, "A2": 150.00, "type": "iso nest"},
        6: {"Cn": 0.11, "C1": 0.13, "A1": 25.0, "C2": 0.35, "A2": 250.00, "type": "iso nest"},
        7: {"Cn": 0.06, "C1": 0.16, "A1": 25.0, "C2": 0.25, "A2": 250.00, "type": "iso nest"},
    }
    ...
    def __init__(self, **kwargs):
        ...
        if self.npcs != 7:
            raise ValueError(
                "Number of principal components must be exactly 7"
                "(%g given)" % self.npcs)
